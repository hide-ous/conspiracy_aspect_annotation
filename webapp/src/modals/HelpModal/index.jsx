      ...
      <Fade in={isOpen} timeout={250}>
        ...
        >
          ...
          <Typography mb={1}>
            ...
            any of the features below for a conspiracy theory. You will then be
            asked to annotate the following conspiratorial features:{' '}
          ...
          <Typography>
            ...
            can be explicit or implicit. When features are stated implicitly
            mark the text passage that approximates the feature the most (e.g.
            “they”), but when they are passively implied without a
            ...
            faced with multiple conspiracy theories identify all features as you
            would for a single theory.
          </Typography>
        </ModalDialog>
      </Fade>
    </Modal>
